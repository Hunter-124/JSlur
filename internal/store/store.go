...
const (
	...
	StatusReview     = "review"     // reach-mode materials, MUST be reviewed before applying (never auto-applied)
...
var TrackingStatuses = map[string]bool{
	StatusReady: true, StatusReview: true, StatusApplied: true, StatusSkipped: true,
...
type Application struct {
	...
	// ReachMode flags an application generated by the "get me an interview" reach
	// mode: its materials were aggressively tailored, so it MUST be reviewed and is
	// never auto-applied. Stretches lists the specific aggressive claims/framings
	// the candidate should be ready to back up in an interview — the checklist for
	// the human review.
	ReachMode bool     `json:"reachMode,omitempty"`
	Stretches []string `json:"stretches,omitempty"`
